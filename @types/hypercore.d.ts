declare module 'hypercore' {
  ...
  class Hypercore extends ReadyResource {
    ...
    clear(start: number, end?: number, options?: { valueEncoding?: any }): Promise<void>
    ...
    replicate(isInitiatorOrReplicationStream: boolean | Connection, options?: ReplicateOptions): any
    ...
    on(event: 'truncate', listener: (ancestors: any, forkId: number) => void): this
