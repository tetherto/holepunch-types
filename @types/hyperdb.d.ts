declare module 'hyperdb' {
  ...
  export type ViewChange<T extends object = HyperDBRecord, K extends object = HyperDBRecord> =
    | {
  ...
  export default class HyperDB {
    ...
    changes<T extends object = HyperDBRecord, K extends object = HyperDBRecord>(range: {
      from: BeeHead
    }): AsyncIterable<ViewChange<T, K>>
