declare module "rocksdb-native" {
  ...
  export type GarbageCollectionPolicy = Values<
    typeof constants.garbageCollectionPolicy
  >;
  export type BottommostLevelCompaction = Values<
    typeof constants.bottommostLevelCompaction
  >;
}
