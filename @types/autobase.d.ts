declare module 'autobase' {
  ...
  declare class Autobase extends ReadyResource {
    constructor(store: Store, bootstrap?: Uint8Array | string | null, handlers?: AutobaseHandlers)
    ...
    static getLocalKey(store: Store, opts?: GetLocalKeyOptions): Promise<Uint8Array>
    ...
    on(event: 'fast-forward', listener: (to: number, from: number) => void): this
